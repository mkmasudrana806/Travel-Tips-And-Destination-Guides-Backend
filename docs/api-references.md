...
| `sort`        | string | Sorting field (`field` or `-field`)   |
| `fields`      | string | Select specific fields (`name,email`) |
| `{fieldName}` | string | Exact match filtering by any field    |

---

## Supported all module's params [Click](./queryparams.md#users)
...
```
GET /users?role=user&status=active
```

Combined example

```
GET /users?search=masud&role=user&page=1&limit=10&sort=-createdAt
```
...
| GET    | `/users` ([params](./query-params.md#users)) | admin  | Get all users      |
...
```
GET /users?search=masud&page=1&limit=10&sort=-createdAt
```
...
| GET    | `/users/:userId/followers` ([params](./query-params.md#userfollow))  | public | Get followers          |
| GET    | `/users/:userId/followings` ([params](./query-params.md#userfollow)) | public | Get followings         |
...
| GET    | `/posts` ([params](./query-params.md#post))    | public      | Get all posts   |
| GET    | `/posts/me` ([params](./query-params.md#post)) | user        | Get my posts    |
...
| GET    | `/posts/:postId/shares` ([params](./query-params.md#postshare)) | public | Get post shares    |
...
| Method | Endpoint                                                  | Access | Description     |
| ------ | --------------------------------------------------------- | ------ | --------------- |
| GET    | `/saved-posts/me` ([params](./query-params.md#savedpost)) | user   | Get saved posts |
...
| GET    | `/posts/:postId/comments` ([params](./query-params.md#comment)) | public | Get root comments |
...
| GET    | `/travel-plans` ([params](./query-params.md#travelplan))    | public | Get travel plans   |
| GET    | `/travel-plans/me` ([params](./query-params.md#travelplan)) | user   | Get my plans       |
...
| GET    | `/travel-plans/:planId/requests` ([params](./query-params.md#travelrequest)) | user   | Get plan requests |
...
| Method | Endpoint                                                          | Access | Description     |
| ------ | ----------------------------------------------------------------- | ------ | --------------- |
| GET    | `/travel-requests/me` ([params](./query-params.md#travelrequest)) | user   | Get my requests |
...
| GET    | `/payments/me` ([params](./query-params.md#payment)) | user   | Get my payments            |
| GET    | `/payments` ([params](./query-params.md#payment))    | admin  | Get all payments           |
